  ...
  return (
    <div className="container py-5 product-container">
      <nav className="breadcrumb">
        ...
        <span className="breadcrumb-item active nav">One Life Graphic T-Shirt</span>
      </nav>
      <div className="row g-5">
        <div className="col-lg-6 text-center">
          <div className="product-image-wrapper">
            <img
              src="/assets/graphic-t-shirt.svg"
              alt="Product"
        ...
        <div className="col-lg-6">
          <h2 className="fw-bold heading">ONE LIFE GRAPHIC T-SHIRT</h2>
          <p className="mb-1">
