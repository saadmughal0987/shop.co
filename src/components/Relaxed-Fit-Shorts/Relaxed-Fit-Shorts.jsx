  ...
  return (
    <div className="container py-5 product-container">
      <nav className="breadcrumb">
        ...
        <span className="breadcrumb-item active nav">Relaxed Fit Shorts</span>
      </nav>
      ...
      <div className="row g-5">
        <div className="col-lg-6 text-center">
          <div className="product-image-wrapper">
            <img
              src="/assets/relaxed-fit-shorts.svg"
              alt="Relaxed Fit Shorts"
        ...
        <div className="col-lg-6">
          <h2 className="fw-bold heading">RELAXED FIT SHORTS</h2>
          <p className="mb-1">
